...
class Critic(BaseAgent):
    ...
    def _build_prompt(
        ...
        prompt_parts.extend([
            ...
            "- verdict: 'SATISFACTORY' or 'UNSATISFACTORY' (Base this purely on whether the Logical and Evidence scores are high)",
            "- confidence_in_verdict: float (0-1)",
            "- composite_score: float (0.00-1.00) -> Sum of (Score * Weight)",
